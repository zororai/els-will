...
import 'spousedetails_model.dart';
export 'spousedetails_model.dart';

class SpousedetailsWidget extends StatefulWidget {
  const SpousedetailsWidget({super.key});

  @override
  State<SpousedetailsWidget> createState() => _SpousedetailsWidgetState();
}

class _SpousedetailsWidgetState extends State<SpousedetailsWidget>
    with TickerProviderStateMixin {
  late SpousedetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SpousedetailsModel());
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SelectionArea(
                          child: Text(
                        'Spouse details (Optional if not married) ',

...
import 'assetadd_model.dart';
export 'assetadd_model.dart';

class AssetaddWidget extends StatefulWidget {
  const AssetaddWidget({super.key});

  @override
  State<AssetaddWidget> createState() => _AssetaddWidgetState();
}

class _AssetaddWidgetState extends State<AssetaddWidget> {
  late AssetaddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AssetaddModel());
